        ...
        <div className="space-y-4">
          ...
          <div className="pt-2">
            ...
            <div className="flex items-center gap-3">
              {/* Facebook */}
              <Link href="https://www.facebook.com/@loksatyanews" target="blank" aria-label="Facebook" className="w-9 h-9 flex items-center justify-center rounded-full bg-gray-800 text-white hover:bg-[#1877F2] transition-colors duration-200">
              ...
              {/* X (Twitter) */}
              <Link href="https://x.com/dainikloksatya?s=21" target="blank" aria-label="Twitter" className="w-9 h-9 flex items-center justify-center rounded-full bg-gray-800 text-white hover:bg-black transition-colors duration-200">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
              </Link>
              {/* Instagram */}
              <Link href="https://www.instagram.com/loksatyatv?igsh=MXdvbXJsNnB5cmVkZw%3D%3D" target="blank" aria-label="Instagram" className="w-9 h-9 flex items-center justify-center rounded-full bg-gray-800 text-white hover:bg-gradient-to-tr from-[#f9ce34] via-[#ee2a7b] to-[#6228d7] transition-colors duration-200">
              ...
              {/* YouTube */}
              <Link href="https://www.youtube.com/@loksatyatv2712?si=8DeavCBxkJuTCInS" target="blank" aria-label="YouTube" className="w-9 h-9 flex items-center justify-center rounded-full bg-gray-800 text-white hover:bg-[#FF0000] transition-colors duration-200">
