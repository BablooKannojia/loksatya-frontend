...
const logo = "/assets/Logo-new-bg.png";
import { IoArrowBackOutline, IoHomeOutline, IoPlayCircleOutline } from "react-icons/io5";
...
const MobileHeader = () => {
  ...
  const searchParamsMH = useSearchParams();
  const searchQueryId = searchParamsMH.toString() ? `?${searchParamsMH.toString()}` : "";
        ...
        >
          ...
          <ul className="mobilevisibleNavItemsUlChild w-[90%]">
            ...
            <li>
              ...
              >
                <IoHomeOutline className="text-lg" aria-label="Home" />
                {/* <span className="text-xs">Home</span> */}
              </Link>
            </li>
            <li>
              <Link
                href="http://epaper.loksatya.com"
            ...
            <li>
              <Link href="/live">
                <IoPlayCircleOutline style={{ fontSize: "18px" }} aria-label="Live" />
              </Link>
            </li>
            ...
            <li>
              <Link href="/itempage2?newsType=videos">
